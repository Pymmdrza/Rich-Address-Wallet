...
| Rich Bitcoin Address Type : **BECH32** (Start with bc1) | 462.7 MB  | `.txt.gz` | [Download](https://github.com/Pymmdrza/Rich-Address-Wallet/releases/latest/) |
| Rich Bitcoin (Type : **P2PKH** & **P2SH** & **BECH32**) | 992.4 MB | `.txt.gz` | [Download](https://github.com/Pymmdrza/Rich-Address-Wallet/releases/latest/) |
